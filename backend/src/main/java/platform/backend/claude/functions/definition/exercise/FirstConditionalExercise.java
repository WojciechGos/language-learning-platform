...
public class FirstConditionalExercise extends ExerciseDefinition{
    public FirstConditionalExercise(String topic) {
        super(topic);
        this.functionPrompt = new ClaudeFunctionPrompt("generate_exercise",
                "Generates exercises for english lessons on the given topic. This is conditional\n" +
                        "        exercise, that helps us to learn first conditional. In the <exercises></exercises> tag\n" +
